...
Spring Cloud is not compatabile with Spring Boot latest version. So, We are using Spring Boot Version '2.3.2.RELEASE' and Spring Cloud Version 'Greenwich.SR2' as specified in [Getting Started Guide](https://spring.io/guides/gs/vault-config/) and [Github Repo](https://github.com/spring-guides/gs-vault-config)
